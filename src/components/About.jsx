      ...
      <div className="flex-col sm:flex sm:flex-row gap-2 p-4">
        <div className="">
          <img
            ...
            alt="Mulindi Jr."
            loading="lazy"
            className="h-80 sm:h-[450px] w-96 rounded-md"
          />
        </div>
        <div className="w-full sm:w-1/2 rounded-md">
          <p className="mt-2 sm:mt-0">
            I'm a full-stack developer specializing in the MERN stack (MongoDB,
            Express, React, Node.js). I build scalable and dynamic web
            applications, focusing on creating seamless user experiences. I'm
            always looking to learn and grow while contributing to exciting
            projects.
          </p>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-purple-600">Moringa School</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-purple-500 w-4 h-4 rounded-full mt-1 mr-4"></div>
