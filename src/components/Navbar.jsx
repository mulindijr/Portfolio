  ...
  return (
    <div className='flex justify-between items-center p-4 mx-44 sticky top-0 z-50 bg-[#161513]'>
      ...
      <ul className='flex space-x-10 text-[20px]'>
        ...
        <li className={`cursor-pointer ${menu==='about' ? 'text-pink-500' : 'text-white'}`}onClick={() => setMenu('about')}> <AnchorLink href='#about' offset={100}>ABout</AnchorLink></li>
        <li className={`cursor-pointer ${menu==='services' ? 'text-pink-500' : 'text-white'}`}onClick={() => setMenu('services')}> <AnchorLink href='#services' offset={100}>Services</AnchorLink></li>
        <li className={`cursor-pointer ${menu==='portfolio' ? 'text-pink-500' : 'text-white'}`}onClick={() => setMenu('portfolio')}> <AnchorLink href='#portfolio' offset={100}>Portfolio</AnchorLink></li>
        <li className={`cursor-pointer ${menu==='contact' ? 'text-pink-500' : 'text-white'}`}onClick={() => setMenu('contact')}> <AnchorLink href='#contact' offset={100}>Contact</AnchorLink></li>
      </ul>
